...
<?php
    ...
    <div class="container">
        <form action="/app/controllers/LoginController.php" id="form_login"  >
            <h1> Login </h1>
            ...
            <div class="row nuevo">
                 <input id="nuevo" name="frist" type="checkbox"> <p>Soy nuevo</p>
            </div>
            <input type="submit"  class="buttom"  value="Iniciar session"> </input>
...
function redirect(){
   ...
   let  checked = document.getElementById('nuevo').checked;
    ...
    window.location.href = "../app/controllers/LoginController.php?email="+email.value+"&password="+password.value+"&action=login&frist="+checked;
}

...
<body>
    ...
    <section class="home">
        ...
        <div class="row">
            ...
            <h1 class="text">  Crea un Departamento </h1>
        </div>
        <br>
        ...
        <div class="form-contain">
            ...
            <hr>
            <form action="/app/controllers/EssaysController.php" method="get" >
                
                    <div class="campos">

                        <div class="campo">
                            <span> Nombre</span>
                            <input value="<?php echo  @$_SESSION['essay']->name ?>" type="text" name="name" id="name" required> 
                        </div>
                    ...
                    <div class="botons">
                        ...
                        <input id="send-btn" class="btn-succ" type="submit"  value="Actualizar Departamento">
                    </div>
            </form>

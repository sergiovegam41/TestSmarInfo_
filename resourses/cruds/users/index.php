...
<body>
    ...
    <section class="home">
        ...
        <div class="actions">
                ...
                <form action="/app/controllers/UsersController.php" method="get">
                    <li class="filter">
                    <ion-icon class ='icon' name="search-outline"></ion-icon>
                        ...
                        <select name="filter_type" id="filter_type">
                            ...
                            <option value="essay_id">Departamento</option>
        ...
        <table class="table scroll-box" >
                ...
                <tr class='cols scroll-box'>
                    ...
                    <td class="col" class="scroll-box" > Departamento </td>
                    <td class="col" class="scroll-box" >Foto de perfil</td>
                ...
                <?php
                    ...
                    foreach ( $_SESSION['users'] as $item ){
                        ...
                        echo ' <tr>
                                    ...
                                    <td class="scroll-box"> '.@$item->essay_name.' </td>
                                    <td class="scroll-box"> <img style="width:50px;border-radius:10px" src="'.'/app/'.str_ireplace('../','',$item->file_url??'storage/Untitled.jpg').'"> </dt>
    ...
    <script>
        function deleteById(id){
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = "/app/controllers/UsersController.php?action=delete&id="+id;
